...
-- CreateTable
CREATE TABLE "MailingListContact" (
    "id" TEXT NOT NULL,
    "siteId" TEXT NOT NULL,
    ...
    CONSTRAINT "MailingListContact_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "DeploymentJob_siteId_status_createdAt_idx" ON "DeploymentJob"("siteId", "status", "createdAt");

-- CreateIndex
CREATE INDEX "DomainCertificate_siteId_status_updatedAt_idx" ON "DomainCertificate"("siteId", "status", "updatedAt");

-- CreateIndex
CREATE UNIQUE INDEX "DomainCertificate_siteId_domain_key" ON "DomainCertificate"("siteId", "domain");
...
-- CreateIndex
CREATE INDEX "CRMContact_siteId_source_createdAt_idx" ON "CRMContact"("siteId", "source", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "CRMContact_siteId_email_key" ON "CRMContact"("siteId", "email");

-- CreateIndex
CREATE INDEX "FormSubmission_siteId_createdAt_idx" ON "FormSubmission"("siteId", "createdAt");

-- CreateIndex
CREATE INDEX "FormSubmission_siteId_pageSlug_idx" ON "FormSubmission"("siteId", "pageSlug");

-- CreateIndex
CREATE INDEX "MailingList_siteId_updatedAt_idx" ON "MailingList"("siteId", "updatedAt");

-- CreateIndex
CREATE INDEX "MailingListContact_siteId_contactId_idx" ON "MailingListContact"("siteId", "contactId");

-- CreateIndex
CREATE UNIQUE INDEX "MailingListContact_mailingListId_contactId_key" ON "MailingListContact"("mailingListId", "contactId");

-- CreateIndex
CREATE INDEX "EmailCampaign_siteId_status_updatedAt_idx" ON "EmailCampaign"("siteId", "status", "updatedAt");

-- CreateIndex
CREATE INDEX "VectorDocument_siteId_namespace_createdAt_idx" ON "VectorDocument"("siteId", "namespace", "createdAt");

-- CreateIndex
CREATE INDEX "VectorDocument_siteId_sourceType_sourceId_idx" ON "VectorDocument"("siteId", "sourceType", "sourceId");

-- CreateIndex
CREATE INDEX "ABExperiment_siteId_status_updatedAt_idx" ON "ABExperiment"("siteId", "status", "updatedAt");

-- CreateIndex
CREATE INDEX "ABExperiment_siteId_pageId_idx" ON "ABExperiment"("siteId", "pageId");

-- CreateIndex
CREATE INDEX "PageVariant_siteId_pageId_active_idx" ON "PageVariant"("siteId", "pageId", "active");

-- CreateIndex
CREATE UNIQUE INDEX "PageVariant_experimentId_key_key" ON "PageVariant"("experimentId", "key");

-- CreateIndex
CREATE INDEX "VariantEvent_siteId_eventType_createdAt_idx" ON "VariantEvent"("siteId", "eventType", "createdAt");

-- CreateIndex
CREATE INDEX "VariantEvent_siteId_variantId_createdAt_idx" ON "VariantEvent"("siteId", "variantId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "DeploymentJob" ADD CONSTRAINT "DeploymentJob_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DomainCertificate" ADD CONSTRAINT "DomainCertificate_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CRMContact" ADD CONSTRAINT "CRMContact_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FormSubmission" ADD CONSTRAINT "FormSubmission_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FormSubmission" ADD CONSTRAINT "FormSubmission_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "CRMContact"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MailingList" ADD CONSTRAINT "MailingList_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MailingListContact" ADD CONSTRAINT "MailingListContact_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MailingListContact" ADD CONSTRAINT "MailingListContact_mailingListId_fkey" FOREIGN KEY ("mailingListId") REFERENCES "MailingList"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MailingListContact" ADD CONSTRAINT "MailingListContact_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "CRMContact"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EmailCampaign" ADD CONSTRAINT "EmailCampaign_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EmailCampaign" ADD CONSTRAINT "EmailCampaign_mailingListId_fkey" FOREIGN KEY ("mailingListId") REFERENCES "MailingList"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VectorDocument" ADD CONSTRAINT "VectorDocument_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ABExperiment" ADD CONSTRAINT "ABExperiment_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ABExperiment" ADD CONSTRAINT "ABExperiment_pageId_fkey" FOREIGN KEY ("pageId") REFERENCES "Page"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PageVariant" ADD CONSTRAINT "PageVariant_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PageVariant" ADD CONSTRAINT "PageVariant_experimentId_fkey" FOREIGN KEY ("experimentId") REFERENCES "ABExperiment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VariantEvent" ADD CONSTRAINT "VariantEvent_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TenantSite"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VariantEvent" ADD CONSTRAINT "VariantEvent_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "PageVariant"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VariantEvent" ADD CONSTRAINT "VariantEvent_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE SET NULL ON UPDATE CASCADE;
