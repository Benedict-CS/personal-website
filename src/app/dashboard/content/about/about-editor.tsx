    ...
    <div className="space-y-6">
      ...
      {!isLoading && hasAnyUnsaved && (
        <div className="flex items-center gap-2 p-3 rounded-lg bg-amber-50 text-amber-800 border border-amber-200">
          ...
          <span className="text-sm font-medium">Some sections have unsaved changes. Remember to click Save on each section.</span>
        </div>
      )}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-1">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  {isDirtyHero && <span className="text-sm text-amber-600 font-medium">Unsaved</span>}
            ...
            <CardContent>
              ...
              <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {isDirtyEducation && <span className="text-sm text-amber-600 font-medium">Unsaved</span>}
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {isDirtyExperience && <span className="text-sm text-amber-600 font-medium">Unsaved</span>}
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {isDirtyProjects && <span className="text-sm text-amber-600 font-medium">Unsaved</span>}
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-sky-500">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-2">
                ...
                {isDirtySkills && <span className="text-sm text-amber-600 font-medium">Unsaved</span>}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-amber-500">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-2">
                ...
                {isDirtyAchievements && <span className="text-sm text-amber-600 font-medium">Unsaved</span>}
              </div>
            </CardContent>
          </Card>
