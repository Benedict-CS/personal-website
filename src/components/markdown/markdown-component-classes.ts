...
export const MARKDOWN_TD_CHECKBOX_INLINE_CLASS =
  "mt-0.5 h-4 w-4 rounded border-border text-blue-600 pointer-events-none flex-shrink-0";

export const MARKDOWN_UL_CLASS = "list-disc list-outside ml-6 mt-0.5 mb-2 space-y-1";
export const MARKDOWN_OL_CLASS = "list-decimal list-outside ml-6 mt-0.5 mb-2 space-y-1";
export const MARKDOWN_LI_CLASS = "text-foreground/90";
