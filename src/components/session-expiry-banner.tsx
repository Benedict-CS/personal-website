...
export function SessionExpiryBanner() {
  ...
  return (
    <div className="sticky top-14 z-40 flex items-center justify-between gap-4 border-b border-amber-200/90 bg-amber-50 px-4 py-2.5 text-sm text-amber-900 shadow-[var(--elevation-1)] sm:top-16">
